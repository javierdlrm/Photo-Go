...
public class LireDemoFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        indexPanelLayout.setHorizontalGroup(indexPanelLayout
                ...
                .addGroup(indexPanelLayout.createSequentialGroup().addContainerGap().addGroup(indexPanelLayout
                        ...
                        .addGroup(indexPanelLayout.createSequentialGroup()
                                .addComponent(textfieldImageDirectoryToIndex, javax.swing.GroupLayout.DEFAULT_SIZE, 629,
                                        Short.MAX_VALUE)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                indexPanelLayout.createSequentialGroup().addComponent(checkBoxAddToExisintgIndex)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(buttonStartIndexing, javax.swing.GroupLayout.PREFERRED_SIZE, 108,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap()));
                ...
                .addGroup(mosaicPanelLayout.createSequentialGroup().addContainerGap()
                        .addGroup(mosaicPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(mosaicPanelLayout.createSequentialGroup().addGroup(mosaicPanelLayout
                                        ...
                                        .addComponent(textfieldMosaicImage, javax.swing.GroupLayout.DEFAULT_SIZE, 492,
                                                Short.MAX_VALUE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
        ...
        vieMenuStartPage.setAccelerator(
        ...
        viewMenuResults.setAccelerator(
        ...
        viewMenuOptions.setAccelerator(
                javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.InputEvent.ALT_MASK));
        ...
        try {
            if (!DirectoryReader.indexExists(open(Paths.get(textfieldIndexName.getText())))) {
                JOptionPane.showMessageDialog(this,
                        "Did not find existing index!\n" + "Use the \"Index\" function to create a new one.", "Error",
    ...
    private void initReader() {
        try {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Could not open index. Please ensure that an index has been created.",
                    "Error opening index", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void buttonStartSearchActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonStartSearchActionPerformed
        if (textfieldSearchImage.getText().length() > 4) {
            ...
            JOptionPane.showMessageDialog(this,
                    "Please select a query image first.\n" + "Use the \"Open image ...\" button to do this.", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void buttonStartIndexingActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonStartIndexingActionPerformed
        if (textfieldImageDirectoryToIndex.getText().length() > 1) {
            ...
            // JOptionPane.showMessageDialog(this, "Please select a directory to index
            // first.\n" +
            // "At least some digital image should be found there.", "Error",
            // JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void rerankLsaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_rerankLsaActionPerformed
        ...
        } else if (selectboxDocumentBuilder.getSelectedIndex() == 17) { // ACCID
            filter = new LsaFilter(ACCID.class, DocumentBuilder.FIELD_NAME_ACCID);
        } else if (selectboxDocumentBuilder.getSelectedIndex() == 18) { // OCR
            filter = new LsaFilter(OCR.class, new OCR().getFieldName());
        } else if (selectboxDocumentBuilder.getSelectedIndex() == 19) { // GPS (Metadata)
    ...
    private void indexAllActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_indexAllActionPerformed
        ...
        // File(textfieldIndexName.getText())));
        // int samples = Math.max(1000, reader.numDocs() / 2);
        // final BOVWBuilder builder = new BOVWBuilder(reader, new SurfFeature(),
        // samples, 500);
        // builder.setProgressMonitor(new javax.swing.ProgressMonitor(this, "Progress of
        // BoVW indexing (~)", "", 0, 100));
    ...
    private void indexMissingActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_indexMissingActionPerformed
        ...
        // IndexReader reader = DirectoryReader.open(FSDirectory.open(new
        // File(textfieldIndexName.getText())));
        // BOVWBuilder builder = new BOVWBuilder(reader, new SurfFeature(),
        // reader.maxDoc() / 10, 2000);
    ...
    private ImageSearcher getSearcher() {
        ...
        if (selectboxDocumentBuilder.getSelectedIndex() == 2) {
        ...
        } else if (selectboxDocumentBuilder.getSelectedIndex() == 19) {
