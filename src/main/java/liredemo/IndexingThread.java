...
public class IndexingThread extends Thread {
    ...
    public void run() {
        ...
        System.out.println("Running 'IndexingThread'...");
        ...
        try {
            ...
            java.util.ArrayList<java.lang.String> images = getAllImages(
                    new java.io.File(parent.textfieldImageDirectoryToIndex.getText()), true);
            if (images == null) {
                JOptionPane.showMessageDialog(parent,
                        "Could not find any files in " + parent.textfieldImageDirectoryToIndex.getText(),
            ...
            // IndexWriter iw;
            // if (create) {
            // iw = LuceneUtils.createIndexWriter(parent.textfieldIndexName.getText(),
            // true);//new IndexWriter(FSDirectory.open(new
            // File(parent.textfieldIndexName.getText())), new SimpleAnalyzer(), create,
            ...
            // ParallelIndexer pin =
            // new ParallelIndexer(8, parent.textfieldIndexName.getText(),
            // parent.textfieldImageDirectoryToIndex.getText(), create){
            // @Override
            ...
            pin.addExtractor(OCR.class);
            pin.addExtractor(GPS.class);
